...
namespace QianShiChat.Infrastructure.Data.Migrations
{
    ...
    [Migration("20231111135835_v0.0.5")]
    partial class v005
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QianShiChat.Domain.Models.FriendGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FriendGroup", (string)null);
                });
            ...
            modelBuilder.Entity("QianShiChat.Domain.Models.MessageAttachment", b =>
                {
                    ...
                    b.HasKey("AttachmentId", "MessageId");
            ...
            modelBuilder.Entity("QianShiChat.Domain.Models.Room", b =>
                {
            ...
            modelBuilder.Entity("QianShiChat.Domain.Models.MessageAttachment", b =>
                {
                    b.HasOne("QianShiChat.Domain.Models.Attachment", "Attachment")
                        .WithMany()
                        .HasForeignKey("AttachmentId");

                    b.HasOne("QianShiChat.Domain.Models.ChatMessage", "Message")
                        .WithMany()
