...
public class UserProfile : Profile
{
    public UserProfile()
    {
        ...
        CreateMap<UserDto, UserWithMessage>()
            .ReverseMap();
        CreateMap<UserRealtion, FriendDto>()
            ...
            .ForMember(d => d.FriendGroupId, m => m.MapFrom(s => s.FriendGroupId))
            .ReverseMap();
...
public class FriendGroupProfile : Profile
{
    public FriendGroupProfile()
    {
